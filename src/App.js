...
function Forgot() {
  ...
  function sendEmail() {
    fetch("https://urlshortener-2425.herokuapp.com/users/forgot", {
      method: "POST",
...
function OpenedEmail() {
  ...
  function getMessage() {
    fetch(`https://urlshortener-2425.herokuapp.com/retrieveAccount/${email}/${token}`, {
      method: "GET",
    })
      .then((data) => data.json())
      .then((userdata) => setMessage(userdata.message));
  ...
  function updatePassword() {
    fetch(`https://urlshortener-2425.herokuapp.com/resetPassword/${email}/${token}`, {
      method: "PUT",
...
function SignUp() {
  ...
  function checkEmail() {
    fetch("https://urlshortener-2425.herokuapp.com/data", {
      method: "POST",
      body: JSON.stringify({ email: email }),
      headers: {
        "Content-Type": "application/json",
  ...
  function createAccount() {
    fetch("https://urlshortener-2425.herokuapp.com/users/SignUp", {
      method: "POST",
...
function ActivateAccount() {
  ...
  const [message, setMessage] = useState('waiting');
  function getMessage() {
    fetch(`https://urlshortener-2425.herokuapp.com/activateAccount/${email}/${token}`, {
      method: "PUT",
    })
      .then((data) => data.json())
      .then((userdata) => setMessage(userdata.message));
...
function Login() {
  ...
  function loginAccount() {
    fetch("https://urlshortener-2425.herokuapp.com/users/Login", {
      method: "POST",
...
function UrlDashboard() {
  ...
  function monthlyData() {
    fetch("https://urlshortener-2425.herokuapp.com/urlGraph/monthly", {
      method: "GET",
    })
      .then((data) => data.json())
  ...
  function dailyData(month) {
    fetch(`https://urlshortener-2425.herokuapp.com/urlGraph/daily/${month}`, {
      method: "GET",
    })
      .then((data) => data.json())
      .then((urldata) => setUrlsData(urldata))
...
function UrlShortener() {
  ...
  function getShortUrl() {
    fetch("https://urlshortener-2425.herokuapp.com/shortUrl", {
      method: "POST",
...
function RedirectToLong() {
  ...
  function redirect() {
    fetch(`https://urlshortener-2425.herokuapp.com/${short}`, {
      method: "GET",
    })
    .then((data)=> data.json())
...
function UrlTable() {
  ...
  function getUrlsData() {
    fetch("https://urlshortener-2425.herokuapp.com/urlsData", {
      method: "GET",
    })
      .then((data) => data.json())
